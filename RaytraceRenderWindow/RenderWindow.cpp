...
RenderWindow::RenderWindow
    ...
    orthographicBox      = new QCheckBox                 ("OrthographicBox",        this);//1.1
    ...
    raytraceButton = new QPushButton("Raytrace",this);//1.1
    ...
    windowLayout->addWidget(orthographicBox,            9,         3,          1,          1           );//1.1
    ...
    windowLayout->addWidget(raytraceButton,0,6,nStacked,1);//1.1
...
void RenderWindow::ResetInterface()
    ...
    orthographicBox  ->setChecked        (renderParameters   ->  orthoProjection);//1.1
